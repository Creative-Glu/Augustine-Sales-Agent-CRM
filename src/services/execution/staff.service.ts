...
async function getDomainToInstitutionMap(): Promise<Map<string, number>> {
  try {
    ...
    throw error instanceof Error ? error : new Error('getDomainToInstitutionMap failed');
  }
}
...
async function getInstitutionIdsForState(state: string): Promise<number[]> {
  try {
    ...
    throw error instanceof Error ? error : new Error('getInstitutionIdsForState failed');
  }
}
...
export async function resolveInstitutionIdsForStates(states: string[]): Promise<number[]> {
  try {
    ...
    throw error instanceof Error ? error : new Error('resolveInstitutionIdsForStates failed');
  }
}
...
export async function getStaffPaginated({
  ...
  try {
    ...
    throw error instanceof Error ? error : new Error('getStaffPaginated failed');
  }
}
...
export async function getStaffForExport(params: StaffExportParams): Promise<Staff[]> {
  try {
    ...
    throw error instanceof Error ? error : new Error('getStaffForExport failed');
  }
}
...
export async function getStaffCounts(
  ...
  try {
    ...
    throw error instanceof Error ? error : new Error('getStaffCounts failed');
  }
}
...
export async function getStaffByInstitutionId(institution_id: number | string): Promise<Staff[]> {
  try {
    ...
    throw error instanceof Error ? error : new Error('getStaffByInstitutionId failed');
  }
}
...
export async function getSyncLogs(offset = 0): Promise<{ data: SyncLogEntry[]; total: number; hasMore: boolean }> {
  try {
    ...
    throw error instanceof Error ? error : new Error('getSyncLogs failed');
  }
}
...
export async function exportStaffCsv(params: Record<string, string>): Promise<void> {
  try {
    ...
    throw error instanceof Error ? error : new Error('exportStaffCsv failed');
  }
}
