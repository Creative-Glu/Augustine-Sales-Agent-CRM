  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        aria-haspopup="menu"
        aria-expanded={open}
        className="group flex items-center gap-2.5 rounded-full border border-slate-200 bg-white hover:bg-slate-50 hover:border-slate-300 px-1.5 py-1 pr-3 shadow-sm cursor-pointer transition-colors"
      >
        <span
      ...
      {open && (
        ...
        >
          {/* Header */}
          <div className="px-4 py-3 bg-linear-to-br from-slate-50 to-blue-50/40 border-b border-slate-100">
          ...
          <div className="px-4 py-3 space-y-1.5">
            <DetailRow
              ...
              label="Role"
              value={
                <span className="inline-flex items-center rounded-md bg-blue-50 border border-blue-200 px-1.5 py-0.5 text-[10px] font-semibold text-blue-800">
                  {user.role}
                </span>
              }
            />
            <DetailRow
              ...
              label="Email"
              value={
                <span className="text-[11px] text-slate-700 truncate block max-w-40">
                  {user.email}
                </span>
              }
            />
            <DetailRow
              icon={<UserCircle2 className="w-3.5 h-3.5 text-slate-400" />}
              label="User ID"
              value={
          ...
          <div className="border-t border-slate-100 p-1.5">
            <button
              ...
              className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-rose-600 hover:bg-rose-50 cursor-pointer transition-colors"
              role="menuitem"
            >
...
function DetailRow({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="text-[10px] font-semibold uppercase tracking-wider text-slate-500 w-12 shrink-0">
        {label}
      </span>
