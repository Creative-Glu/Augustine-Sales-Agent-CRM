...
export default function DateRangePicker({ value, onChange }: DateRangePickerProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <label className="inline-flex items-center gap-1.5 text-[11px] font-medium text-slate-700 dark:text-slate-200">
      ...
      <select
        ...
        className="rounded-md border border-border bg-card px-2.5 py-1.5 text-xs text-slate-800 dark:text-slate-200 cursor-pointer focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-100"
      >
      ...
      {value.preset === 'custom' && (
        <div className="flex items-center gap-1.5">
          <input
            ...
            className="rounded-md border border-border bg-card px-2 py-1 text-xs text-slate-800 dark:text-slate-200 cursor-pointer focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-100"
      ...
      {value.preset !== 'none' && (
        <button
          ...
          className="inline-flex items-center gap-1 rounded-md border border-border bg-card px-2 py-1 text-[11px] font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/40 cursor-pointer transition-colors"
