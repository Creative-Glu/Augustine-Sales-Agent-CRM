...
const SLOT_META: Record<SlotKey, SlotMeta> = {
  1: {
    ...
    pillRing: 'ring-emerald-200 dark:ring-emerald-500/30',
  ...
  2: {
    ...
    pillRing: 'ring-blue-200 dark:ring-blue-500/30',
  ...
  3: {
    ...
    pillRing: 'ring-violet-200 dark:ring-violet-500/30',
      ...
      <DialogContent className="sm:max-w-170 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-5">
          ...
          <section className="rounded-xl border border-border bg-card overflow-hidden shadow-sm">
            <div className="bg-linear-to-br from-blue-50 via-indigo-50 to-violet-50 dark:from-blue-950/40 dark:via-indigo-950/40 dark:to-violet-950/40 px-5 py-4 border-b border-border">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  {product.product_description && (
                    <p className="mt-1 text-xs text-slate-600 dark:text-slate-400 leading-relaxed line-clamp-3">
                      {product.product_description}
                    </p>
                  )}
                </div>
          ...
          <section className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
            <div className="bg-linear-to-r from-slate-50 to-indigo-50/40 dark:from-slate-800/60 dark:to-indigo-950/40 px-5 py-3 border-b border-border flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="inline-flex items-center justify-center w-6 h-6 rounded-md bg-indigo-100 text-indigo-600 dark:bg-indigo-500/15 dark:text-indigo-300">
                  <Layers className="w-3.5 h-3.5" />
                </span>
                <div>
                  <p className="text-xs font-bold text-slate-900 dark:text-slate-100">Attached Product Offers</p>
            ...
            <div className="p-4">
              ...
              {!isLoading && !isError && attached.length > 0 && (
                <div className="flex flex-wrap items-center gap-2 mb-3 text-[10px] text-slate-500 dark:text-slate-400">
              ...
              {!isLoading && isError && (
                <div className="rounded-lg border border-rose-200 dark:border-rose-500/30 bg-rose-50 dark:bg-rose-500/15 px-3 py-3 text-center">
                  ...
                  <p className="text-[12px] font-medium text-rose-800 dark:text-rose-400">
              ...
              {!isLoading && !isError && attached.length === 0 && (
                <div className="rounded-lg border border-dashed border-border bg-muted/50 px-4 py-6 text-center">
                  ...
                  <p className="text-[12px] font-semibold text-slate-700 dark:text-slate-200">Not bundled yet</p>
                  <p
                    ...
                    return (
                      <li key={offer.offer_id}>
                        <a
                          ...
                          className="group relative block rounded-lg border border-border bg-card hover:bg-blue-50/40 dark:hover:bg-blue-500/10 hover:border-blue-300 dark:hover:border-blue-500/40 hover:shadow-md transition-all overflow-hidden"
                        >
                          ...
                          <div className="pl-4 pr-3 py-3">
                            ...
                            <div className="flex items-start justify-between gap-3 mb-2">
                              ...
                              <ArrowUpRight className="w-4 h-4 text-slate-300 dark:text-slate-600 group-hover:text-blue-600 dark:group-hover:text-blue-400 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-all shrink-0" />
                            </div>
  ...
  return (
    <div className="px-4 py-3 flex items-start gap-3">
      ...
      <div className="min-w-0">
        ...
        <p
          className={`mt-0.5 text-sm font-bold text-slate-900 dark:text-slate-100 ${
...
function ColoredChip({ icon, label, tint, mono }: ColoredChipProps) {
  const tintMap: Record<ColoredChipProps['tint'], string> = {
    ...
    slate: 'bg-muted/50 text-slate-700 dark:text-slate-200 border-border',
